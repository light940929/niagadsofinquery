...
func main() {
	...
	for snprd.Scan() {
		...
		req.Header.Set("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJJRCI6Ik5JQUdBRFMiLCJleHAiOjE0NjI5NDEwOTJ9.XeVx2iNYa4nk7QfA3cu9m69r8cN9RcZXhAQRz0UATEI")
		client := &http.Client{}
